...
const oneLineFunction = (parameter1, parameter2) => `The first parameter is ${parameter1}. The second parameter is ${parameter2}.`


console.log(oneLineFunction(1, 2))
...
function passingTotalCostArray(totalCost){
...
console.log(pricesPlusTax(prices, passingTotalCostArray))
...
function multiplyingFactory(num1){
    return function multiplyingLogic(num2){
    if (num1 >= 5){
